...
type ApiDeleteCustomFormatBulkRequest struct {
	ctx context.Context
	ApiService *CustomFormatAPIService
	customFormatBulkResource *CustomFormatBulkResource
}

func (r ApiDeleteCustomFormatBulkRequest) CustomFormatBulkResource(customFormatBulkResource CustomFormatBulkResource) ApiDeleteCustomFormatBulkRequest {
	r.customFormatBulkResource = &customFormatBulkResource
	return r
}

func (r ApiDeleteCustomFormatBulkRequest) Execute() (*http.Response, error) {
	return r.ApiService.DeleteCustomFormatBulkExecute(r)
}

/*
DeleteCustomFormatBulk Method for DeleteCustomFormatBulk

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiDeleteCustomFormatBulkRequest
*/
func (a *CustomFormatAPIService) DeleteCustomFormatBulk(ctx context.Context) ApiDeleteCustomFormatBulkRequest {
	return ApiDeleteCustomFormatBulkRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
func (a *CustomFormatAPIService) DeleteCustomFormatBulkExecute(r ApiDeleteCustomFormatBulkRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodDelete
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CustomFormatAPIService.DeleteCustomFormatBulk")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/customformat/bulk"
	...
	// body params
	localVarPostBody = r.customFormatBulkResource
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["apikey"]; ok {
...
func (r ApiListCustomFormatSchemaRequest) Execute() ([]CustomFormatSpecificationSchema, *http.Response, error) {
	return r.ApiService.ListCustomFormatSchemaExecute(r)
}
...
type ApiPutCustomFormatBulkRequest struct {
	ctx context.Context
	ApiService *CustomFormatAPIService
	customFormatBulkResource *CustomFormatBulkResource
}

func (r ApiPutCustomFormatBulkRequest) CustomFormatBulkResource(customFormatBulkResource CustomFormatBulkResource) ApiPutCustomFormatBulkRequest {
	r.customFormatBulkResource = &customFormatBulkResource
	return r
}

func (r ApiPutCustomFormatBulkRequest) Execute() (*CustomFormatResource, *http.Response, error) {
	return r.ApiService.PutCustomFormatBulkExecute(r)
}

/*
PutCustomFormatBulk Method for PutCustomFormatBulk

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiPutCustomFormatBulkRequest
*/
func (a *CustomFormatAPIService) PutCustomFormatBulk(ctx context.Context) ApiPutCustomFormatBulkRequest {
	return ApiPutCustomFormatBulkRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return CustomFormatResource
func (a *CustomFormatAPIService) PutCustomFormatBulkExecute(r ApiPutCustomFormatBulkRequest) (*CustomFormatResource, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CustomFormatAPIService.PutCustomFormatBulk")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
