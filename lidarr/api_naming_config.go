...
func (r ApiGetApiV1ConfigNamingExamplesRequest) RenameTracks(renameTracks bool) ApiGetApiV1ConfigNamingExamplesRequest {
...
func (r ApiGetApiV1ConfigNamingExamplesRequest) StandardTrackFormat(standardTrackFormat string) ApiGetApiV1ConfigNamingExamplesRequest {
	r.standardTrackFormat = &standardTrackFormat
	return r
}

func (r ApiGetApiV1ConfigNamingExamplesRequest) MultiDiscTrackFormat(multiDiscTrackFormat string) ApiGetApiV1ConfigNamingExamplesRequest {
	r.multiDiscTrackFormat = &multiDiscTrackFormat
	return r
}

func (r ApiGetApiV1ConfigNamingExamplesRequest) ArtistFolderFormat(artistFolderFormat string) ApiGetApiV1ConfigNamingExamplesRequest {
	r.artistFolderFormat = &artistFolderFormat
	return r
}

func (r ApiGetApiV1ConfigNamingExamplesRequest) IncludeArtistName(includeArtistName bool) ApiGetApiV1ConfigNamingExamplesRequest {
	r.includeArtistName = &includeArtistName
	return r
}

func (r ApiGetApiV1ConfigNamingExamplesRequest) IncludeAlbumTitle(includeAlbumTitle bool) ApiGetApiV1ConfigNamingExamplesRequest {
