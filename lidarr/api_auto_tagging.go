...
func (a *AutoTaggingAPIService) CreateAutoTaggingExecute(r ApiCreateAutoTaggingRequest) (*AutoTaggingResource, *http.Response, error) {
	...
	localVarPath := localBasePath + "/api/v1/autotagging"
...
func (a *AutoTaggingAPIService) DeleteAutoTaggingExecute(r ApiDeleteAutoTaggingRequest) (*http.Response, error) {
	...
	localVarPath := localBasePath + "/api/v1/autotagging/{id}"
...
func (r ApiListAutoTaggingSchemaRequest) Execute() ([]AutoTaggingSpecificationSchema, *http.Response, error) {
	return r.ApiService.ListAutoTaggingSchemaExecute(r)
}
...
*/
func (a *AutoTaggingAPIService) ListAutoTaggingSchema(ctx context.Context) ApiListAutoTaggingSchemaRequest {
	return ApiListAutoTaggingSchemaRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *AutoTaggingAPIService) ListAutoTaggingSchemaExecute(r ApiListAutoTaggingSchemaRequest) ([]AutoTaggingSpecificationSchema, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  []AutoTaggingSpecificationSchema
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AutoTaggingAPIService.ListAutoTaggingSchema")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/autotagging/schema"
