...
// checks if the PrimaryAlbumType type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PrimaryAlbumType{}
...
type NullablePrimaryAlbumType struct {
	value *PrimaryAlbumType
	isSet bool
}

func (v NullablePrimaryAlbumType) Get() *PrimaryAlbumType {
	return v.value
}

func (v *NullablePrimaryAlbumType) Set(val *PrimaryAlbumType) {
	v.value = val
	v.isSet = true
}
...
func NewNullablePrimaryAlbumType(val *PrimaryAlbumType) *NullablePrimaryAlbumType {
	return &NullablePrimaryAlbumType{value: val, isSet: true}
}
