...
func (a *QueueAPIService) GetQueueExecute(r ApiGetQueueRequest) (*QueueResourcePagingResource, *http.Response, error) {
	...
	if r.includeUnknownArtistItems != nil {
		...
		var defaultValue bool = false
		parameterAddToHeaderOrQuery(localVarQueryParams, "includeUnknownArtistItems", defaultValue, "form", "")
	...
	if r.includeAlbum != nil {
		...
		var defaultValue bool = false
		parameterAddToHeaderOrQuery(localVarQueryParams, "includeAlbum", defaultValue, "form", "")
